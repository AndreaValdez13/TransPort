...
?>
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i><img src="images/ticketg.svg" width="45"
     height="45"></i></div>
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i><img src="images/analyticsg.svg" width="60"
     height="60"></i></div>
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i><img src="images/convertg.svg" width="60"
     height="60"></i></div>
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i><img src="images/groupg.svg" width="60"
     height="60"></i></div>
