<?php	
	...
	if (empty($_POST['name'])) {
		...
		$rol=$_POST["rol"];
		$codempleado=mysqli_real_escape_string($con,(strip_tags($_POST["codempleado"],ENT_QUOTES)));
		$profile_pic="default.png";

		$is_admin=0;
		if(isset($_POST["is_admin"])){$is_admin=1;}

			$sql="INSERT INTO user ( name, password, email, profile_pic, is_active, created_at, rol, codempleado) VALUES ('$end_name','$password','$email','$profile_pic',$status,'$created_at', '$rol', '$codempleado')";
