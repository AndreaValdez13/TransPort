                ...
                <div class="animate form login_form">
                    ...
                    <section class="login_content">
                        <form action="action/login.php" method="post">
                            ...
                            <div>
                                <input type="text" name="email" class="form-control" placeholder="Usuario o Correo Electronico" required />
                            </div>
                            <div>
                            ...
                            <div class="separator">
                                ...
                                <br />
                                <div>
                                    <h1><i class="fa fa-ticket"></i> TransPort GT </h1>
                                    <p> <a style="text-decoration: underline;">SISTEMA ALQUILERES VENTAS</a>SEMINARIO <a>2022</a></p>
                                </div>
                            </div>
                        </form>
                    </section>
