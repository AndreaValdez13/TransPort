            ...
            <table class="table table-striped jambo_table bulk_action">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title">Transaccion </th>
                        <th>Fecha</th>
                ...
                <tbody>
                <?php
    if($userrol == 0) //usuario
    {
        $queryrol=mysqli_query($con, "SELECT * from ticket where user_id='".$idusr."'");
?>
                <?php 
                        while ($r=mysqli_fetch_array($queryrol)) {
                            $id=$r['id'];
